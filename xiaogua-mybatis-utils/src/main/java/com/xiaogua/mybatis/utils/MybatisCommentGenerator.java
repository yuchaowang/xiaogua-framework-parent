package com.xiaogua.mybatis.utils;
...
public class MybatisCommentGenerator implements CommentGenerator {
    ...
    public void addGeneralMethodComment(Method method, IntrospectedTable introspectedTable) {
        ...
        returnType =
            returnType.lastIndexOf(".") != -1 ? returnType.substring(returnType.lastIndexOf(".") + 1) : returnType;
    ...
    private void addComment(JavaElement javaElement, IntrospectedTable introspectedTable,
        IntrospectedColumn introspectedColumn) {
        // 添加字段注释
        StringBuffer comment = new StringBuffer();
