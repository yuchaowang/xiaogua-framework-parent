...
public abstract class BaseSsoController {
	...
	@Autowired
	private ILoginGrpcServiceGrpc.ILoginGrpcServiceBlockingStub sso2LoginSBS;
	...
	private com.usoft.sso2.grpc.api.entity.UserLoginState checkLogin(String token) {
		try {
			...
			if (clResponse.getUserLoginState().equals(com.usoft.sso2.grpc.api.entity.UserLoginState.getDefaultInstance())) {
				//与默认由相等，则相当于Null
				return null;
			}
