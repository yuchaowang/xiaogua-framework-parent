...
public class Sso2GrpcConfig {
	...
	@Value("${sso.grpc-host}")
	private String sso2GrpcHost;
	@Value("${sso.grpc-port}")
	private int sso2GrpcPort;
	@Value("${sso.grpc-timeout}")
	...
	public ILoginGrpcServiceGrpc.ILoginGrpcServiceBlockingStub getLoginGrpcServiceBlockingStub(ManagedChannel sso2ManagedChannel) {
		ILoginGrpcServiceGrpc.ILoginGrpcServiceBlockingStub loginGrpcServiceBlockingStub = ILoginGrpcServiceGrpc.newBlockingStub(sso2ManagedChannel)
